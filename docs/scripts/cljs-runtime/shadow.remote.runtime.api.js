...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_28917 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_28917(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_28919 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_28919(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_28925 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_28925(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_28928 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_28928(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_28933 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_28933(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_28935 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_28935(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__28898,callback){
var map__28900 = p__28898;
var map__28900__$1 = cljs.core.__destructure_map(map__28900);
var input = map__28900__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28900__$1,new cljs.core.Keyword(null,"code","code",1586293142));
